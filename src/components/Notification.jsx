  ...
  function newNotification(messageType) {
    switch (messageType) {
      ...
      default:
        return {
          img: icon_wins95,
          text1: 'Welcome to this retro blog! 🎉',
          text2: 'I will be posting some cool stuff here soon!, Including projects, tutorials, retro hardware and software, and more!. Thanks for visiting!', 
          function: ''
        };
    }
  }
